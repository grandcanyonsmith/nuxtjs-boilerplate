      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div class="md:col-span-2">
          <div class="flex items-center space-x-2 mb-4">
            ...
            <h3 class="text-2xl font-bold">Xpress A/C Specialists</h3>
          </div>
          <p class="text-gray-300 mb-4 max-w-md">
            Your trusted partner for professional automotive A/C services. 
            Keeping you cool and comfortable on the road since 2009.
          </p>
        ...
        <div>
          ...
          <div class="space-y-2 text-gray-300">
            ...
            <p class="flex items-start">
              ...
              <span>123 Auto Service Dr<br>Anytown, ST 12345</span>
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="container-custom py-6">
        <div class="flex flex-col md:flex-row justify-between items-center">
          <p class="text-gray-400 text-sm mb-4 md:mb-0">
            © {{ currentYear }} Xpress A/C Specialists. All rights reserved.
          </p>
